...
public class Economy extends Plugin {
    ...
    public void onEnable() {
        ...
        database.execute("CREATE TABLE IF NOT EXISTS `Pricelist` (`ID` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `ItemID` INT, `ItemVariation` INT, `ItemName` VARCHAR(32), `ItemPrice` INT);");
    }
